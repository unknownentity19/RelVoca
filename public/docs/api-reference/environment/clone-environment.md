...
````yaml /specs-prettified/realtime/openapi.stable.json post /v1/stable/environment/{environmentAlias}/clone
openapi: 3.0.0
info:
  title: Realtime
...
tags: []
paths:
  /v1/stable/environment/{environmentAlias}/clone:
    post:
      tags:
        - Environment
      summary: Clone environment
      description: >-
        Copies an environment into a new one under an alias you choose, giving
        somewhere to change the agent without touching the environment being
        cloned.
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/StableEnvironmentCloneRequest'
      responses:
        '201':
          description: >-
            Returns the new environment, including the alias that subsequent
            calls pass as environmentAlias to target it.
          content:
            application/json:
              schema:
  ...
  schemas:
    StableEnvironmentCloneRequest:
      ...
      properties:
        ...
        alias:
          type: string
          description: Short URL-safe identifier; cannot be 'main' (reserved).
      required:
        - name
        - alias
