...
````yaml /specs-prettified/realtime/openapi.stable.json post /v1/stable/playbook
openapi: 3.0.0
info:
  title: Realtime
...
paths:
  /v1/stable/playbook:
    post:
      ...
      description: >-
        Adds a playbook to the environment, a set of instructions that drives an
        agent toward a goal, calling tools as it needs them. The response
      ...
      responses:
        '201':
          description: >-
            Returns the newly created playbook in full, including the ID
            assigned to it and the instructions it was created with.
          content:
            application/json:
              schema:
