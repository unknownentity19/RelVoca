...
````yaml /specs-prettified/realtime/openapi.stable.json get /v1/stable/variable
openapi: 3.0.0
info:
  title: Realtime
...
paths:
  /v1/stable/variable:
    get:
      ...
      description: >-
        Returns every variable in the project. A variable is a named slot of
        project state an agent can read and write. The call takes no paging
      ...
      responses:
        '200':
          description: >-
            Returns every variable defined in the project environment, each with
            its name, description, default value, colour, and whether the
            platform owns it as a system variable.
          content:
            application/json:
              schema:
          ...
          x-vf-doc:
            description: >-
              Returns every variable defined in the project environment, each
              with its name, description, default value, colour, and whether the
              platform owns it as a system variable.
      security:
        - token: []
components:
